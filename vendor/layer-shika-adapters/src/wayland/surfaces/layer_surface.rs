...
impl SurfaceCtx {
    pub(crate) fn setup(
        ...
        Self::configure_layer_surface(&layer_surface, &surface, config, setup_params.compositor, setup_params.queue_handle);
    ...
    fn configure_layer_surface(
        ...
        // Empty input region: no area accepts pointer/touch input → full passthrough
